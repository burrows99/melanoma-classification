...
class TrainTransform:
    ...
    albumentations is used only for CLAHE, blur variants, and RandomRotate90
    (no direct torchvision.v2 equivalents). Everything else uses torchvision.v2.
    """
    ...
    def __init__(self):
        ...
        # torchvision v2: all remaining transforms
        self._tv = v2.Compose([
    ...
    def __call__(self, pil_img):
        np_img = self._alb(image=np.array(pil_img))['image']
        return self._tv(Image.fromarray(np_img))
